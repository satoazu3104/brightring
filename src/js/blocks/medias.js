...
registerBlockType('portart/medias', {
  ...
  edit: ({ className, attributes, setAttributes }) => {
    ...
    const { imageUrl, mobileImageUrl, imageUploadUrl, mobileImageUploadUrl, addClassName } = attributes;
      ...
      <>
        {(imageUrl || imageUploadUrl) && (
          <picture className={fixPictureClass}>
            ...
            <img className={imageUploadUrl ? fixClass : fixClass + 'block-media'} data-src={imageUrl} src={imageUploadUrl ? imageUploadUrl : ''} alt="media" />
          </picture>
        )}
      </>
    )
